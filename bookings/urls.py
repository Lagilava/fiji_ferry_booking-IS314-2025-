...
urlpatterns = [
    ...
    path('api/pricing/', views.get_pricing, name='get_pricing'),  # Updated: Consistent API path
    ...
    path('api/create_checkout_session/', views.create_checkout_session, name='create_checkout_session'),  # Updated: Moved to api/
